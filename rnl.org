...
*** 2.4.13 Propagating Constraints
    constraint-based system, declarative programming, one-directional, general model of relationships, a means of combination, connectors, constraints network, computation
...
**** Question:                                                    :QUESTIONS:
     1. "*connector* can notify *other constraints* in response to the change"怎么理解？是 "connector 通知其他 constraints 来响应变化" 还是 "connector 响应变化并通知其他 constraints"？
     2. 
* Funcs
** Expressions
*** Types of expressions
