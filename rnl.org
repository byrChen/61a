...
*** 3.2.5 Turtle graphics                                           :TOBEORG:
    #+begin_src scheme 
      ...
      nil
    #+end_src
    #+DOWNLOADED: /tmp/screenshot.png @ 2019-09-16 10:20:28
    [[file:pictures/Chapter_3:_Interpreting_Computer_Programs/screenshot_2019-09-16_10-20-28.png]]
    #+begin_src scheme 
      > (define (repeat k fn)
          (if (> k 0)
              (begin (fn) (repeat (- k 1) fn))
      ...
      > (sier 400 6)
    #+end_src
    #+DOWNLOADED: /tmp/screenshot.png @ 2019-09-16 10:21:12
    [[file:pictures/Chapter_3:_Interpreting_Computer_Programs/screenshot_2019-09-16_10-21-12.png]]
** 3.3 Exceptions
