...
****** Question        
       ...
       |                          | ~fact~                                                                                   | ~fact_iter~                     |
       | Computation              | *final to base* and *complicate to simple*                                               | *base to final* and *identical* |
       | Name numbers             | 1: ~n~                                                                                   | 2: ~total, k~                   |
       | Env numbers              | 4: f1~f4                                                                                 | 2: f1~f2                        |
       | Correctness varification | a form of proof by *induction*: *trust* ~fact(n-1)~ *correct* and *only check* ~fact(n)~ |                                 |
       |                          |                                                                                          |                                 |
