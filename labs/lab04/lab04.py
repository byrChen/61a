...
def distance(city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    result = (get_lat(city1) - get_lat(city2)) ** 2 + (get_lon(city1) - get_lon(city2)) ** 2
    return sqrt(result)
...
def closer_city(lat, lon, city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    intermediary = make_city('intermediary', lat, lon)
    closer_city = city1 if distance(city1, intermediary) < distance(city2, intermediary) else city2
